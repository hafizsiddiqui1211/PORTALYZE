...
class PDFGenerator:
    ...
    def _create_key_metrics_section(self, analysis_result: AnalysisResult, keyword_suggestions: Optional[List[KeywordSuggestion]]) -> List:
    ...
    def _create_top_keyword_suggestions_section(self, keyword_suggestions: Optional[List[KeywordSuggestion]]) -> List:
